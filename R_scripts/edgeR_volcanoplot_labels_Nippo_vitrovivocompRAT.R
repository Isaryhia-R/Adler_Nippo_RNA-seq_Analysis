...
### VT comparison all to day 0 Rat - MUST CHANGE TITLES ###

##CHANGE COLORS!! Change orchid1 to slategray2 

edger_C8 <- exactTest(y, pair=c("VT_0d_rFem","VT_1d_rFem"))$table

edger_C9 <- exactTest(y, pair=c("VT_0d_rMale","VT_1d_rMale"))$table

edger_C10 <- exactTest(y, pair=c("VT_0d_rFem","VT_2d_rFem"))$table

edger_C11 <- exactTest(y, pair=c("VT_0d_rMale","VT_2d_rMale"))$table

edger_C12 <- exactTest(y, pair=c("VT_0d_rFem","VT_3d_rFem"))$table

edger_C13 <- exactTest(y, pair=c("VT_0d_rMale","VT_3d_rMale"))$table

edger_C14 <- exactTest(y, pair=c("VT_0d_rFem","VT_5d_rFem"))$table

edger_C15  <- exactTest(y, pair=c("VT_0d_rMale","VT_5d_rMale"))$table

edger_C16 <- exactTest(y, pair=c("VT_0d_rFem","VT_7d_rFem"))$table

edger_C17 <- exactTest(y, pair=c("VT_0d_rMale","VT_7d_rMale"))$table
...
volcano_C8 = ggplot(data=edger_C8, aes(x=logFC, y=-log10(PValue), col=diffexpressed, label=delabel)) +
  ...
  scale_color_manual(values=c("slategray2", "grey","royalblue4")) +
  geom_vline(xintercept=c(-1, 1), col="black") +
  geom_hline(yintercept=-log10(0.05), col="black") +
  xlim(-15,15) +ylim(0,100) +  ggtitle("Rat-derived day 0 Vs. day 1 Females") +
...
volcano_C9 = ggplot(data=edger_C9, aes(x=logFC, y=-log10(PValue), col=diffexpressed, label=delabel)) +
  ...
  geom_vline(xintercept=c(-1, 1), col="black") +
  geom_hline(yintercept=-log10(0.05), col="black") +
  xlim(-15,15) +ylim(0,100) +  ggtitle("Rat-derived day 0 Vs. day 1 Males") +
...
volcano_C10 = ggplot(data=edger_C10, aes(x=logFC, y=-log10(PValue), col=diffexpressed, label=delabel)) +
  ...
  geom_vline(xintercept=c(-1, 1), col="black") +
  geom_hline(yintercept=-log10(0.05), col="black") +
  xlim(-15,15) +ylim(0,100) +  ggtitle("Rat-derived day 0 Vs. day 2 Females") +
...
volcano_C11 = ggplot(data=edger_C11, aes(x=logFC, y=-log10(PValue), col=diffexpressed, label=delabel)) +
  ...
  geom_vline(xintercept=c(-1, 1), col="black") +
  geom_hline(yintercept=-log10(0.05), col="black") +
  xlim(-15,15) +ylim(0,100) +  ggtitle("Rat-derived day 0 Vs. day 2 Males") +
...
volcano_C12 = ggplot(data=edger_C12, aes(x=logFC, y=-log10(PValue), col=diffexpressed, label=delabel)) +
  ...
  geom_vline(xintercept=c(-1, 1), col="black") +
  geom_hline(yintercept=-log10(0.05), col="black") +
  xlim(-15,15) +ylim(0,100) +  ggtitle("Rat-derived day 0 Vs. day 3 Females") +
...
volcano_C13 = ggplot(data=edger_C13, aes(x=logFC, y=-log10(PValue), col=diffexpressed, label=delabel)) +
  ...
  geom_vline(xintercept=c(-1, 1), col="black") +
  geom_hline(yintercept=-log10(0.05), col="black") +
  xlim(-15,15) +ylim(0,100) +  ggtitle("Rat-derived day 0 Vs. day 3 Males") +
...
volcano_C14 = ggplot(data=edger_C14, aes(x=logFC, y=-log10(PValue), col=diffexpressed, label=delabel)) +
  ...
  geom_vline(xintercept=c(-1, 1), col="black") +
  geom_hline(yintercept=-log10(0.05), col="black") +
  xlim(-15,15) +ylim(0,100) +  ggtitle("Rat-derived day 0 Vs. day 5 Females") +
...
volcano_C15 = ggplot(data=edger_C15, aes(x=logFC, y=-log10(PValue), col=diffexpressed, label=delabel)) +
  ...
  geom_vline(xintercept=c(-1, 1), col="black") +
  geom_hline(yintercept=-log10(0.05), col="black") +
  xlim(-15,15) +ylim(0,100) +  ggtitle("Rat-derived day 0 Vs. day 5 Males") +
...
volcano_C16 = ggplot(data=edger_C16, aes(x=logFC, y=-log10(PValue), col=diffexpressed, label=delabel)) +
  ...
  geom_vline(xintercept=c(-1, 1), col="black") +
  geom_hline(yintercept=-log10(0.05), col="black") +
  xlim(-15,15) +ylim(0,100) +  ggtitle("Rat-derived day 0 Vs. day 7 Females") +
...
volcano_C17 = ggplot(data=edger_C17, aes(x=logFC, y=-log10(PValue), col=diffexpressed, label=delabel)) +
  ...
  geom_vline(xintercept=c(-1, 1), col="black") +
  geom_hline(yintercept=-log10(0.05), col="black") +
  xlim(-15,15) +ylim(0,100) +  ggtitle("Rat-derived day 0 Vs. day 7 Males") +
...
pdf("./DE/edgeR_volcano_RatVTvsday0_males_lfc1_pval0.05_labels.pdf",width = 18, height =8)
